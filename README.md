...
| 文档 | 作用 |
|---|---|
| `00-running-log.md` | 运行日志，按任务编号记录关键流水、判断和通过结果 |
...
本仓库不是官方文档，而是一次认证实践过程的开源实验记录。任务 1～7 已全部完成并通过平台检测，当前阶段主要进行手册完善和录屏交付。

文档中的步骤、截图和报错排查以当前实验环境为准。当前最终标签为 `v0.7-task7-embedding-rerank`。
