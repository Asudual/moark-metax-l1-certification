...
当前项目主要覆盖认证前置准备、GPU 实例租用、环境检查，以及任务 1～任务 6 的完成过程。README 只作为项目导航，具体命令、截图和排错过程请进入对应 Markdown 文档查看。
...
| 任务 7 | 未整理完成 | 当前仓库中对应文档仍为空或待补充，不在本 README 中声明完成结果 |
...
| `code/` | 保存实验中使用或整理出的脚本代码，例如任务 2～任务 6 的推理和 FastAPI 服务代码 |
